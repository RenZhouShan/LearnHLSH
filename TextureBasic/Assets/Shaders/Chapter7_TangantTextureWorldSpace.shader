...
Shader "Unlit/Chapter7/Tangent Texture WorldSpace"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            {   
                ...
                fixed3 bump = UnpackNormal(tex2D(_BumpMap, i.uv.zw));//对法线贴图进行采样
                bump.xy *= _BumpScale;
                bump.z = normalize(half3(dot(i.TtoW0.xyz, bump), dot(i.TtoW1.xyz, bump), dot(i.TtoW2.xyz, bump)));
